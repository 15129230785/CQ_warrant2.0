...
<body>
	...
	<fieldset>
		<legend>还款通知</legend>
		<div class="L1" id="payNotice"></div>
	</fieldset>
	<div style="display:none"class="download">
		<a href="../download/down.jsp?name=hktz&end=.doc">还款通知单模版下载</a>
	</div>
	<br />
		...
		<fieldset>
			...
			<table>
				<tr style="display: none;">
					...
					<td><input type="text" id="num" value="notice" /></td>
...
<script type="text/javascript" src="<%=basePath%>js/service/notice.js"></script>
</body>
</html>