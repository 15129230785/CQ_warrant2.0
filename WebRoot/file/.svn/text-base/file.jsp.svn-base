...
<body>
	<form action="File" id="file" method="post">
		<div id="body">
		...
		<br />
		<fieldset>
			<legend>前期收集客户资料清单</legend>
			<div class="L1" id="docList"></div>
		</fieldset>
		<br />
		<fieldset>
			<legend>签订的合同文本清单</legend>
		...
		<fieldset>
			...
			<table>
				<tr style="display: none;">
					...
					<td><input type="text" id="num" value="file" /></td>
...
<script type="text/javascript" src="<%=basePath%>js/service/file.js"></script>
