...
<body>
	...
	<fieldset>
		...
		<table>
			<tr>
				<td>担保金额(万元)：</td>
				<td><input type="text" id="returnMoney" readonly /></td>
			</tr>
			<tr>
				<td>保证金(元)：</td>
				<td><input type="text" id="bailMoney" value="" readonly /></td>
			</tr>
		</table>
	</fieldset>
	<br />
	<form action="ReturnBail" id="returnBail" method="post">
		<fieldset>
			<legend>项目提交</legend>
			<table>
				<tr style="display: none;">
					...
					<td><input type="text" id="num" value="returnbail" /></td>
			...
			<table>
				<tr>
					<td width="90">处理方式：</td>
					<td><select name="sel" id="processid" onchange="thisSel()" style="width: 150px">
			...
			<input type="button" onclick="tijiao()" value="提交" style="width: 50px; height: 22px" />
		</fieldset>
	</form>
...
<script type="text/javascript" src="<%=basePath%>js/service/returnbail.js"></script>
