...
<body>
	<div class="center_content_head">
		<span class="cchhover"><font class="head_fcl"></font>修改分析类指标系数</span>
	</div>
	<div class="edit_wrap">
		<div class="edit_comp">
			<form action="updateAnalysisindex" method="post">
			<input type="text" name="iid" id="iid" style="display : none" value="<%=iid%>"/>
				<table>
					...
					<tr>
						...
						<span>系数：</span></td>
						<td class="edit_comp_r">
						<input class="comp_input" name="ratio" id="ratio" style="width: 200px;" type="text" value="<%=ratio%>" />
						</td>
					</tr>
					<tr>
