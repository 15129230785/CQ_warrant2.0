...
<script type="text/javascript">
	...
	function init() {
		xmlhttp = initxmlhttp();
		setTimeout("analysisindexupdateclose()", 1000);
	}
	
	function analysisindexupdateclose() {
		var fdbdiv = window.parent.opener.document.getElementById("analysisindexdiv");
