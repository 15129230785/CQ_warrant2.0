...
<body>
	<a href="#" id="dlBtn">下载系统日志</a>
	<div id="filelistdiv"></div>
	<form method="post" action="SysLog!downloadLogFile" id="frmdl"></form>
...
<script type="text/javascript" src="<%=basePath%>js/syslog.js" charset="utf-8"></script>
</body>
</html>